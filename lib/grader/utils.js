var SANDBOX = require('./executor').SANDBOX,
  SANDBOX_PATH = Config.sandbox.root2,
  fs = require('fs'),
...
exports.cleanUpSandbox = function(id, dirPath) {
  ...
  if (files.length > 0) {
    ...
    zipper.writeZip(SANDBOX_PATH + '/zipps/' + id + '.zip');
  }
...
exports.getDiffLines = function(data) {
  var solution = data.solution,
    ...
    zipper = new AdmZip(SANDBOX_PATH + '/zipps/' + solution._id + '.zip'),
    fileName = 'output-' + testCase,
    filePath = SANDBOX_PATH + '/zipps/',
